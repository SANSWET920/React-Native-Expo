    ...
    render() {
        return (
            <TouchableHighlight style={styles.captureButton} disabled ={this.props.buttonDisabled}>
                <Button onPress={this.props.onClick} disabled={this.props.buttonDisabled} 
                title= {this.props.isNotCap  ?"V1/V2 Api":"Capture" }accessibilityLabel="Learn more about this button"/>
            </TouchableHighlight>
        );
    }
}
