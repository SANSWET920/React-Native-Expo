    ...
    <ScrollView showsVerticalScrollIndicator={false}>
        ...
        >
            ...
            <Image 
                 ...
                 style={{ width: 240, height:40, left:70, top:8}}
           ...
           {this.state.MovieCardData.map((data,index) => (
               ...
               <TouchableOpacity
                ...
                key={index}
                 ...
                 this.props.navigation.push("Go_Back", {
...
<ContinueText>School of Computing</ContinueText>
  ...
  {this.state.Season1.map((data,index) => (
      ...
      <TouchableOpacity
       ...
       key={index}
        ...
        this.props.navigation.push("Computer_Science_and_Engineering", {
...
<ContinueText1>School of Electrical and Electronics</ContinueText1>
  ...
  {this.state.Season2.map((data,index) => (
      ...
      <TouchableOpacity
       ...
       key={index}
        ...
        this.props.navigation.push("Electronics_and_Communication_Engineering", {
...
<ContinueText2>School of Mechanical</ContinueText2>
  ...
  {this.state.Season3.map((data,index) => (
      ...
      <TouchableOpacity
       ...
       key={index}
        ...
        this.props.navigation.push("Mechatronics_Engineering", {
...
<ContinueText3>School of Bio and Chemical</ContinueText3>
  ...
  {this.state.Season4.map((data,index) => (
      ...
      <TouchableOpacity
       ...
       key={index}
        ...
        this.props.navigation.push("Bio_and_Chemical_Engineering", {
...
<ContinueText4>School of Science</ContinueText4>
  ...
  {this.state.Season5.map((data,index) => (
      ...
      <TouchableOpacity
       ...
       key={index}
        ...
        this.props.navigation.push("Science", {
...
<ContinueText5>School of Law</ContinueText5>
  ...
  {this.state.Season6.map((data,index) => (
      ...
      <TouchableOpacity
       ...
       key={index}
        ...
        this.props.navigation.push("Law", {
